...
<head>
    ...
    <style>
        body {
            background: url(img/bg_herzenland.jpg) top center;
            background-size: 100%;
...
<div class="container" style="background: url(img/fon.png);">
    <img alt="Logo_HerzenLand" class="align-items-center text-align: center-img" width="453" height="80" src="img/name_herzenland1.png">
    <div class="container mt-5 md-5" style="background: url(img/fon.png); width: 80%;">
        <?php require "Parts/herzenland_news1.php" ?>
    </div>
    <div class="container mt-5 md-5" style="background: url(img/fon.png); width: 80%;">
        <?php require "Parts/herzenland_news2.php" ?>
    </div>
