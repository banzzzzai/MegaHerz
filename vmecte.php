...
<html lang="ru">
    <head>
        ...
        <style>
            body {
                background: url(img/bg_vmecte1.png) top center;
                background-size: 100%;
    ...
    <body>
        ...
        <div class="container">
            <img alt="Logo_Vmecte" class="align-items-center text-align: center-img" width="258" height="63" src="img/name_vmecte1.png">

            <div class="container mt-5 md-5" style="background: url(img/fon.png); width: 80%;">
                <?php require "Parts/vmecte_news1.php" ?>
            </div>
            <div class="container mt-5 md-5" style="background: url(img/fon.png); width: 80%;">
                <?php require "Parts/vmecte_news2.php" ?>
            </div>
